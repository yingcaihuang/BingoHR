...
func TestParseDocx(t *testing.T) {
	...
	analysis, err := resumeAnalyzer.AnalyzeFile(nil, jobTitle, jobRequirements, jobDescription, "/Users/captain/develop/verycloud/microsoft/hr-jianli/成都/朱先生_28岁_智联简历_95766-杭安恒信息.docx")
	if err != nil {
